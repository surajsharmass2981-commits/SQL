/* 
   MERGED SQL ASSIGNMENT FILE
   Includes: Basic SQL + Advanced SQL Assignments
*/
...
1️. Eliminate redundant data (avoid data duplication)
2️. Ensure logical data storage (data dependency makes sense)
3️. Improve data consistency and efficiency
*/
